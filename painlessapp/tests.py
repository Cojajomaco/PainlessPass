...
class UserPasswordsTestCase(TestCase):
    def test_create_user(self):
        # Create first user
        new_user_id = instantiate_user("testuser", "testpass", "testuser@mek-tech.net")
        # User should exist
        self.assertEqual(User.objects.get(username="testuser").id, new_user_id)
        ...
        self.assertTrue(Folder.objects.exists(name="None", user_id=new_user_id))
